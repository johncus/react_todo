...
This is a solution to a small app challenge called "ToDo List".
To Do List will have a text box, a button and below that a list of ToDos.
The list will be empty to start.
After entering text you click the button.
After clicking the text will be added to a list of ToDos and the text in the box disappears
(Optional) Display a running track of the number of items in the ToDo list.

Clicking on an item in the ToDo list removes them
